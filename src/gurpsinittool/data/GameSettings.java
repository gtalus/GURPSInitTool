...
public class GameSettings {
	...
	public boolean AUTO_STUN = true; // Apply stun results when taking damage
	public boolean AUTO_UNSTUN = true; // Automatically check for stun recovery for each enemy
}
